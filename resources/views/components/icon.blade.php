...
@php
    // Inner SVG (stroke style, viewBox 24). Satu sumber ikon untuk seluruh app.
    $icons = [
...
<svg {{ $attributes->class('shrink-0') }} fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
    {!! $icons[$name] ?? '' !!}
</svg>
